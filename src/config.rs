...
//    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = Default::default();
	pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "Wh-123456".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["112.74.36.233"];
pub const RS_PUB_KEY: &str = "ZTxJH69k44Vv1pSqWcYtxvdjkDTHc0EK1chdithtqSw=";
